...
class Tes3Reader:
    ...
    def unpackSubHeader(self, recType="----", expName=None, expSize=0):
        ...
        if expName and expName != name:
            raise Tes3Error(
                self.inName,
                _("%s: Expected %s sub-record, but found %s instead.")
...
class Book(Record):
    ...
    def __init__(
        self, name="BOOK", size=0, delFlag=0, recFlag=0, ins=None, unpack=False
    ):
        """Initialization."""
    ...
    def loadData(self, ins):
        ...
        while bytesRead < self.size:
            ...
            # --Map Note?
                ...
                if subGroup >= 20:
                    raise Tes3Error(
                        self.ins, self.getId() + _(": Second NAM0 subrecord.")
                    )
                subGroup = 20
                if size != 4:
        ...
        for object in self.getObjects().list():
            ...
            for record in objRecords:
                ...
                if isinstance(record, Cell_Frmr):
                    if (
                        iMod > 255 and settings["mash.extend.plugins"]
                    ):  # MWSE compatibility == enabled
                        out.pack("4si", "FRMR", 8)
...
class Crec(ContentRecord):
    ...
    def __init__(
        self, name="CREC", size=0, delFlag=0, recFlag=0, ins=None, unpack=False
    ):
        # --Arrays
        self.id = None
        self.index = 0
...
class Cntc(ContentRecord):
    ...
    def __init__(
        self, name="CNTC", size=0, delFlag=0, recFlag=0, ins=None, unpack=False
    ):
        # --Arrays
        self.id = None
        self.index = 0
...
class Dial(Record):
    ...
    def __init__(
        self, name="DIAL", size=0, delFlag=0, recFlag=0, ins=None, unpack=False
    ):
        # --Arrays
        self.id = None
        self.type = 0
...
class Fmap(Record):
    ...
    def __init__(
        self, name="FMAP", size=0, delFlag=0, recFlag=0, ins=None, unpack=False
    ):
        """Initialize."""
...
class Glob(Record):
    ...
    def __init__(
        self, name="GLOB", size=0, delFlag=0, recFlag=0, ins=None, unpack=False
    ):
        """Initialization."""
        self.type = "l"
        self.value = 0
...
class Info(Record):
    ...
    def __init__(
        self, name="INFO", size=0, delFlag=0, recFlag=0, ins=None, unpack=False
    ):
        """Initialization."""
        # --Info Id
        self.id = ""
...
class Land(Record):
    ...
    def __init__(
        self, name="LAND", size=0, delFlag=0, recFlag=0, ins=None, unpack=False
    ):
        """Initialize."""
        self.id = None
        # self.gridX = 0
...
class Npcc(ContentRecord):
    ...
    def __init__(
        self, name="NPCC", size=0, delFlag=0, recFlag=0, ins=None, unpack=False
    ):
        # --Arrays
        self.id = None
        self.index = 0
...
class Scpt(Record):
    ...
    def __init__(
        self, name="SCPT", size=0, delFlag=0, recFlag=0, ins=None, unpack=False
    ):
        # --Arrays
        self.id = None
        self.numShorts = 0
...
class Tes3(Record):
    ...
    def __init__(
        self, name="TES3", size=0, delFlag=0, recFlag=0, ins=None, unpack=False
    ):
        """Initialize."""
        self.hedr = None
        ...
        if not self.openmw:  # Morrowind
            ...
            if len(inItms) < len(itms):
                itmsR = [
                    ...
                    in [
                        fl
                        for fl in os.listdir(os.path.dirname(self.openmwPathDict[x]))
                        if x.lower() == fl.lower()
                    ]
                ]
                self.loadFilesDups = True
...
class FileRefs(FileRep):
    ...
    def remapObject(self, object, newIMod, newIObj=-1):
        ...
        if objRecords and objRecords[0].name == "MVRF":
            ...
            if (
                newIMod > 255 and settings["mash.extend.plugins"]
            ):  # MWSE compatibility == enabled
